...
/>
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-center sm:justify-start">
                  <div className="bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/30 dark:to-emerald-900/30 border border-emerald-100 dark:border-emerald-800 px-3 py-2 rounded-xl flex items-center gap-2 justify-center sm:justify-start">
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 border border-green-100 dark:border-green-800 px-3 py-2 rounded-xl flex items-center gap-2 justify-center sm:justify-start">
                    ...
                    <div className="text-center sm:text-left">
                      ...
                      <span className="text-sm font-semibold text-gray-800 dark:text-gray-200">
                        {/* If you want to track activity in DB, replace this */}
                        Today
                      </span>
                    </div>
                  </div>
